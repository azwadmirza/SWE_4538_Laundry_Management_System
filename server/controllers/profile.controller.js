...
const updateManagerProfile=async(req,res)=>{
    try{
        ...
        laundry.profilePicture=req.file?"http://localhost:8080/uploads/"+req.file.filename:laundry.profilePicture;
        await laundry.save();
...
const updateCustomerProfile=async(req,res)=>{
    try{
        ...
        user.profilePicture=req.file?"http://localhost:8080/uploads/"+req.file.filename:user.profilePicture;
        await user.save();
